...
> To go on a tangent for a moment about internalising ideas. 
...
The hope was that I'd converge to a behaviour set I want over time by increasing the friction to reach anduse these sites, along with changing what I valued by uh... self-harrassment[^7]? For reference, my current behaviours in relation to media usage now are:
